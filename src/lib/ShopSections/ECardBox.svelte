...
{#snippet optionIcon(iconName: string)}
	...
	{:else if iconName === 'potluckEnabled'}
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
	...
	{:else if iconName === 'privacyEnabled'}
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
	...
	{:else if iconName === 'disposableCameraEnabled'}
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
	...
	{:else if iconName === 'schedulingEnabled'}
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
	...
	{:else if iconName === 'signaturedEnabled'}
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
